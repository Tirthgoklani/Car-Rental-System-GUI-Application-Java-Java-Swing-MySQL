...
public class UserDashboard {
    ...
    private void createNavBar() {
        ...
        // Modern back button
        JButton backButton = createStyledButton("Back", accentColor, Color.WHITE);
        backButton.addActionListener(e -> {
            frame.dispose();
            // Show message for exit functionality
            JOptionPane.showMessageDialog(null, "Back button clicked. In a real app, this would go back to the main menu.");
        });
        
        navBar.add(title, BorderLayout.WEST);
        navBar.add(backButton, BorderLayout.EAST);
    ...
    private void showRentDialog(String carDetails, int carId) {
        ...
        rentDialog.setSize(500, 400); // Larger dialog
    ...
    private void showConfirmation(String carDetails) {
        ...
        JLabel detailsLabel = new JLabel("You have successfully booked the " + carDetails);
        detailsLabel.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        detailsLabel.setForeground(textColor);
        detailsLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JLabel instructionLabel = new JLabel("Check your email for the confirmation details.");
        instructionLabel.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        instructionLabel.setForeground(secondaryTextColor);
        ...
        closeButton.addActionListener(e -> {
            ...
            refreshCarListings(); // Refresh the car listings after booking
        });
